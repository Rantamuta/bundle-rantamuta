...
/** @type {WeakMap<object, ReturnType<typeof createConversationDefinitionService>>} */
 ...
 * @returns {{ status: 'none' } | { status: 'bound', binding: { relativePath: string, absolutePath: string, areaPath: string, bundle: string, areaName: string } } | { status: 'broken', error: { code: string, message: string, playerMessage: string, details?: Record<string, *> } }}
 */
...
/**
 * @param {{ relativePath: string, absolutePath: string, areaPath: string, bundle: string, areaName: string }} binding
 * @returns {{ status: 'loaded', definition: { id: string, initial: string, states: Record<string, *>, sourcePath: string, absolutePath: string, bundle: string, areaName: string } } | { status: 'broken', error: { code: string, message: string, playerMessage: string, details?: Record<string, *> } }}
 */
...
/**
 * @param {*} state
 * @returns {ReturnType<typeof createConversationDefinitionService>}
 */
