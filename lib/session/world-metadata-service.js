 ...
 * @param {boolean} force
 * @param {(valuesRoot: Record<string, *>, segments: string[], force: boolean, operationName: string) => { deleted: boolean, parent?: Record<string, *>, leafKey?: string, previousValue?: * }} deletePath
 * @returns {{ deleted: boolean, parent?: Record<string, *>, leafKey?: string, previousValue?: * }}
 */
