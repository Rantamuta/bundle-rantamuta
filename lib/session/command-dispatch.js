...
function consumeBubbleContribution(candidate, renderMessages, diagnostics) {
  ...
  if (Object.prototype.hasOwnProperty.call(contribution, 'renderPolicy')) {
    Logger.error('Bubble contribution attempted to set renderPolicy.replaceSuccess. Bubble may contribute render only.');
  }
...
/**
 * This function interprets render instructions from the Plan phase and Bubble
