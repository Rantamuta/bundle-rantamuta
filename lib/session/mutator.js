...
function applyDoorMutationInstruction(state, instruction) {
  ...
  if (!result || result.ok !== true) {
    const warningPrefix = instruction && typeof instruction.__legacyType === 'string' && instruction.__legacyType
      ? instruction.__legacyType
      : `doorMutation(${instruction.mutation})`;
