...
const CANONICALIZATION_RULES = [
  ...
  [/^\s*ne\s*$/i, 'go northeast'], // n
  [/^\s*northeast\s*$/i, 'go northeast'], // n
  [/^\s*nw\s*$/i, 'go northwest'], // n
  [/^\s*northwest\s*$/i, 'go northwest'], // n
  [/^\s*se\s*$/i, 'go southeast'],// s
  [/^\s*southeast\s*$/i, 'go southeast'],// s
  [/^\s*sw\s*$/i, 'go southwest'],// s
  [/^\s*southwest\s*$/i, 'go southwest'],// s
  [/^\s*up\s*$/i, 'go up'], // up
