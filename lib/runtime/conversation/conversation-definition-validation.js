 ...
 * @returns {void}
 */
function appendInstructionValidationErrors(errors, effects, sourceLabel) {
  const validation = validateAuthoredInstructions(effects, { source: sourceLabel });
  if (validation.ok) {
    return;
  }
...
function validateConversationDefinition(doc, sourceLabel = '') {
  ...
  for (const [stateId, stateDef] of Object.entries(states)) {
    ...
    if (onEntry && Object.prototype.hasOwnProperty.call(onEntry, 'effects')) {
      appendInstructionValidationErrors(errors, onEntry.effects, sourceLabel);
    }
    ...
    for (const [eventId, eventDef] of Object.entries(events)) {
      ...
      if (eventId === 'default') {
        ...
        if (Object.prototype.hasOwnProperty.call(eventDef, 'effects')) {
          appendInstructionValidationErrors(errors, eventDef.effects, sourceLabel);
        }
        continue;
      }
      ...
      for (const transition of transitions) {
        ...
        if (Object.prototype.hasOwnProperty.call(transition, 'effects')) {
          appendInstructionValidationErrors(errors, transition.effects, sourceLabel);
        }
