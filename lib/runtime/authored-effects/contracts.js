...
/**
 * @module runtime/authored-effects/contracts
 * @description
 * Shared contract definitions for the authored-effects runtime surface.
 *
 * This file centralizes the small result shapes used by authored-effects
 ...
 * - `lib/runtime/authored-effects/index.js`
 * - `lib/runtime/authored-effects/transposer.js`
 * - `lib/runtime/authored-effects/validator.js`
 *
 * This file does not validate authored effects, resolve references, lower
