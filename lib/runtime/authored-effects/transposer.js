...
/**
 * @module runtime/authored-effects/transposer
 * @description
 * Plain-language summary:
 *
 * This file is the mechanical bridge from authored effect data to executable
 * runtime instruction data.
 *
 * It takes YAML-shaped authored effects plus an explicit runtime scope and
 * returns one of two things:
 *
 * - canonical mutation operations and render messages, or
 * - one structured failure
 *
 * This is the file to use when a system already has authored effect entries
 ...
 * Scope rules:
 *
 * - validate through the shared authored-effects validator
