  ...
  return createTransposeSuccess([], [
    {
      ...
      ...(payload.targetRoomRef !== undefined ? { targetRoomRef: expandRoomRef(scope, payload.targetRoomRef) } : {}),
      ...(payload.exceptSelector !== undefined ? { exceptSelector: payload.exceptSelector } : {}),
      ...(payload.exceptRoomRef !== undefined ? { exceptRoomRef: expandRoomRef(scope, payload.exceptRoomRef) } : {}),
    },
  ]);
};
