...
describe('scenario runner', function () {
  ...
  test('scenario runner codex Tomo scenario shows caretaker guidance flow', () => {
    ...
    // "take bell" and "take reliquary" are expected to fail.
    assert.match(result.stdout, /take bell/);
    assert.match(result.stdout, /The bell is fixed to the ancient frame\./);
